...
namespace Controles_1.Controles
{
    ...
    public partial class RJTextBox : UserControl
    {
        ...
        private Color placeholdercolor = Color.Coral;
        ...
        public string Texts
        {
            get
            {
                // Retorna el valor del texto si no es placeholder
                if (isPlaceholder)
                    return "";
                else
            ...
            set
            {
                ...
                textBox1.Text = value;
                SetPlaceholder();  // Asegurarse de manejar el placeholder
            }
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (borderRadius > 1)//Bordes redondos
            {
                var rectBorderSmooth = this.ClientRectangle;
                var rectBorder = Rectangle.Inflate(rectBorderSmooth, -borderSize, -borderSize);
                int smootSize = borderSize > 0 ? borderSize : 1;
                ...
                using (Pen penBorder = new Pen(bordercolor, borderSize))
                {
                    ...
                    if (borderRadius > 15) SetTextBoxRoundedRegion(); //motrar textBox redondeado
                    graphics.SmoothingMode = SmoothingMode.AntiAlias;
                    penBorder.Alignment = System.Drawing.Drawing2D.PenAlignment.Center;

                    //Cambiar Color del txt seleccionado
                    if (isFocused) penBorder.Color = borderFocusColor;
                    {

                        if (underlinedStyle) //Estilo Linea
                        {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            if (!isPlaceholder)
            {
                // Solo invocar el evento si no es placeholder
        ...
        private void textBox1_Leave(object sender, EventArgs e)
        {
            ...
            // Solo muestra el placeholder si está vacío
        ...
        private void textBox1_DataContextChanged(object sender, EventArgs e)
        {
